...
function App() {
  ...
  return (
    <div className='bg-cream min-h-screen w-full pb-12'>
      {/*Initial Header */}
        <div className=' flex flex-row flex-wrap bg-sage  font-roboto items-center py-20 px-5 gap-x-10'>
          {/*Left column */}
          ...
          <div className="flex flex-row flex-wrap gap-x-4 my-4 max-w-screen-sm  font-medium text-sm">
            <a
              className="px-7 py-3 bg-mint hover:bg-bright_mint text-white shadow-md border border-white  rounded-xl  mt-2 transition-colors duration-300 "
              href="./Quote.tsx"
            >
            ...
            <a
              className="px-7 py-3 bg-transparent hover:bg-bright_sage text-white shadow-md rounded-xl  border border-white mt-2 transition-colors duration-300"
              href="./Services.tsx"
            >
